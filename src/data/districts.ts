...
export const DISTRICTS: District[] = [
  ...
  { id: 'novosibirsk-berdsk', name: 'Бердск', regionId: 'novosibirsk', type: 'city' },
  { id: 'novosibirsk-iskitim', name: 'Искитим', regionId: 'novosibirsk', type: 'city' },
  { id: 'novosibirsk-kuybyshev', name: 'Куйбышев', regionId: 'novosibirsk', type: 'city' },
  { id: 'novosibirsk-barabinsky', name: 'Барабинский район', regionId: 'novosibirsk', type: 'district' },
  { id: 'novosibirsk-iskitimsky', name: 'Искитимский район', regionId: 'novosibirsk', type: 'district' },
  { id: 'novosibirsk-karasuksky', name: 'Карасукский район', regionId: 'novosibirsk', type: 'district' },
  { id: 'novosibirsk-kuybyshevsky', name: 'Куйбышевский район', regionId: 'novosibirsk', type: 'district' },
  { id: 'novosibirsk-toguchinsky', name: 'Тогучинский район', regionId: 'novosibirsk', type: 'district' },
  { id: 'novosibirsk-chulymsky', name: 'Чулымский район', regionId: 'novosibirsk', type: 'district' },
  ...
  // Татарстан - другие города и районы
  { id: 'tatarstan-naberezhnye-chelny', name: 'Набережные Челны', regionId: 'tatarstan', type: 'city' },
  { id: 'tatarstan-nizhnekamsk', name: 'Нижнекамск', regionId: 'tatarstan', type: 'city' },
  { id: 'tatarstan-almetyevsk', name: 'Альметьевск', regionId: 'tatarstan', type: 'city' },
  { id: 'tatarstan-zelenodolsk', name: 'Зеленодольск', regionId: 'tatarstan', type: 'city' },
  { id: 'tatarstan-bugulma', name: 'Бугульма', regionId: 'tatarstan', type: 'city' },
  { id: 'tatarstan-agryzsky', name: 'Агрызский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-aktanyshsky', name: 'Актанышский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-alekseevsky', name: 'Алексеевский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-alkeevsky', name: 'Алькеевский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-apastovsky', name: 'Апастовский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-atninsky', name: 'Атнинский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-buinsky', name: 'Буинский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-vysokogorsky', name: 'Высокогорский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-zainsky', name: 'Заинский район', regionId: 'tatarstan', type: 'district' },
  { id: 'tatarstan-zelenodolsky', name: 'Зеленодольский район', regionId: 'tatarstan', type: 'district' },
  ...
  { id: 'moscow-region-korolev', name: 'Королёв', regionId: 'moscow-region', type: 'city' },
  { id: 'moscow-region-serpukhov', name: 'Серпухов', regionId: 'moscow-region', type: 'city' },
  { id: 'moscow-region-orekhovo-zuevo', name: 'Орехово-Зуево', regionId: 'moscow-region', type: 'city' },
  { id: 'moscow-region-ramensky', name: 'Раменский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-domodedovo', name: 'Домодедовский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-dmitrov', name: 'Дмитровский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-sergiev-posad', name: 'Сергиево-Посадский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-klin', name: 'Клинский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-stupino', name: 'Ступинский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-volokolamsk', name: 'Волоколамский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-istra', name: 'Истринский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-krasnogorsk', name: 'Красногорский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-pushkino', name: 'Пушкинский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-shchelkovo', name: 'Щёлковский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-naro-fominsk', name: 'Наро-Фоминский район', regionId: 'moscow-region', type: 'district' },
  { id: 'moscow-region-chekhov', name: 'Чеховский район', regionId: 'moscow-region', type: 'district' },

  // Ленинградская область
  { id: 'leningrad-gatchina', name: 'Гатчинский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-vyborg', name: 'Выборгский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-vsevolozhsk', name: 'Всеволожский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-tikhvin', name: 'Тихвинский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-kirishi', name: 'Киришский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-lomonosov', name: 'Ломоносовский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-tosno', name: 'Тосненский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-volkhov', name: 'Волховский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-luga', name: 'Лужский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-kingisepp', name: 'Кингисеппский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-priozersk', name: 'Приозерский район', regionId: 'leningrad', type: 'district' },
  { id: 'leningrad-boksitogorsk', name: 'Бокситогорский район', regionId: 'leningrad', type: 'district' },
  ...
  { id: 'krasnodar-anapa', name: 'Анапа', regionId: 'krasnodar', type: 'city' },
  { id: 'krasnodar-yeysk', name: 'Ейск', regionId: 'krasnodar', type: 'city' },
  { id: 'krasnodar-slavyansk', name: 'Славянск-на-Кубани', regionId: 'krasnodar', type: 'city' },
  { id: 'krasnodar-tikhoretsk', name: 'Тихорецкий район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-kavkazsky', name: 'Кавказский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-krymsky', name: 'Крымский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-apsheronsky', name: 'Апшеронский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-belorechensky', name: 'Белореченский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-kurganinsky', name: 'Курганинский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-labinsky', name: 'Лабинский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-mostovsky', name: 'Мостовский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-otradnensky', name: 'Отрадненский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-seversky', name: 'Северский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-temryuksky', name: 'Темрюкский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-tuapsinsky', name: 'Туапсинский район', regionId: 'krasnodar', type: 'district' },
  { id: 'krasnodar-uspensky', name: 'Успенский район', regionId: 'krasnodar', type: 'district' },

  // Свердловская область (дополнительные города и районы)
  ...
  { id: 'sverdlovsk-berezovsky', name: 'Берёзовский', regionId: 'sverdlovsk', type: 'city' },
  { id: 'sverdlovsk-verkhnyaya-pyshma', name: 'Верхняя Пышма', regionId: 'sverdlovsk', type: 'city' },
  { id: 'sverdlovsk-asbest', name: 'Асбест', regionId: 'sverdlovsk', type: 'city' },
  { id: 'sverdlovsk-revda', name: 'Ревда', regionId: 'sverdlovsk', type: 'city' },
  { id: 'sverdlovsk-alapaevsky', name: 'Алапаевский район', regionId: 'sverdlovsk', type: 'district' },
  { id: 'sverdlovsk-artemovsky', name: 'Артёмовский район', regionId: 'sverdlovsk', type: 'district' },
  { id: 'sverdlovsk-achitsky', name: 'Ачитский район', regionId: 'sverdlovsk', type: 'district' },
  { id: 'sverdlovsk-baykalovsky', name: 'Байкаловский район', regionId: 'sverdlovsk', type: 'district' },
  { id: 'sverdlovsk-beloyarsky', name: 'Белоярский район', regionId: 'sverdlovsk', type: 'district' },
  { id: 'sverdlovsk-bogdanovich', name: 'Богдановичский район', regionId: 'sverdlovsk', type: 'district' },
  ...
  { id: 'voronezh-anninsky', name: 'Аннинский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-bobrovsky', name: 'Бобровский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-bogucharsky', name: 'Богучарский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-buturlinovsky', name: 'Бутурлиновский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-verkhnemamonsky', name: 'Верхнемамонский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-vorobyevsky', name: 'Воробьёвский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-kalacheevsky', name: 'Калачеевский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-kamenskyi', name: 'Каменский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-liskinsky', name: 'Лискинский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-novousmansky', name: 'Новоусманский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-ostrogozhsky', name: 'Острогожский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-pavlovsky', name: 'Павловский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-povorinsky', name: 'Поворинский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-ramonsky', name: 'Рамонский район', regionId: 'voronezh', type: 'district' },
  { id: 'voronezh-rossoshansky', name: 'Россошанский район', regionId: 'voronezh', type: 'district' },

  // Волгоградская область - районы
  { id: 'volgograd-alaninskyi', name: 'Алания район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-bykovskyi', name: 'Быковский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-gorodishchensky', name: 'Городищенский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-dubovsky', name: 'Дубовский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-zhirnovsky', name: 'Жирновский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-ilovlinsky', name: 'Иловлинский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-kalachevsky', name: 'Калачёвский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-kamyshinskyi', name: 'Камышинский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-kikvidzensky', name: 'Кикидзенский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-kotelnikovsky', name: 'Котельниковский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-kotovsky', name: 'Котовский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-mikhailovsky', name: 'Михайловский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-nikolaevsky', name: 'Николаевский район', regionId: 'volgograd', type: 'district' },
  { id: 'volgograd-novonikolaevsky', name: 'Новониколаевский район', regionId: 'volgograd', type: 'district' },

  // Ростовская область - районы  
  { id: 'rostov-azovsky', name: 'Азовский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-aksaisky', name: 'Аксайский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-bagaevsky', name: 'Багаевский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-belokalitvensky', name: 'Белокалитвенский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-bokovsky', name: 'Боковский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-verkhnedonskoy', name: 'Верхнедонской район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-volgodonsky', name: 'Волгодонской район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-dubovsky-r', name: 'Дубовский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-egorliksky', name: 'Егорлыкский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-zimovnikovsky', name: 'Зимовниковский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-kagalnicky', name: 'Кагальницкий район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-kamenskyi', name: 'Каменский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-konstantinovsky', name: 'Константиновский район', regionId: 'rostov', type: 'district' },
  { id: 'rostov-krasnosulinsky', name: 'Красносулинский район', regionId: 'rostov', type: 'district' },

  // Самарская область - районы
  { id: 'samara-alekseevsky', name: 'Алексеевский район', regionId: 'samara', type: 'district' },
  { id: 'samara-bezenchuksky', name: 'Безенчукский район', regionId: 'samara', type: 'district' },
...
sky', name: 'Борский район', regionId: 'samara', type: 'district' },
  ...
  { id: 'samara-kamyshlinskyi', name: 'Камышлинский район', regionId: 'samara', type: 'district' },
  { id: 'samara-kinelsky', name: 'Кинельский район', regionId: 'samara', type: 'district' },
  { id: 'samara-kinel-cherkassky', name: 'Кинель-Черкасский район', regionId: 'samara', type: 'district' },
  { id: 'samara-koshkinsky', name: 'Кошкинский район', regionId: 'samara', type: 'district' },

  // Челябинская область - районы
  { id: 'chelyabinsk-argayashsky', name: 'Аргаяшский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-ashinsky', name: 'Ашинский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-bredinskyi', name: 'Брединский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-varnensky', name: 'Варненский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-verkhneуralsky', name: 'Верхнеуральский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-yemanzhelinskyi', name: 'Еманжелинский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-zlatoustovsky', name: 'Златоустовский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-kaslinsky', name: 'Каслинский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-katav-ivanovsky', name: 'Катав-Ивановский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-kizilsky', name: 'Кизильский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-kopeiskiy', name: 'Копейский район', regionId: 'chelyabinsk', type: 'district' },
  { id: 'chelyabinsk-krasnoarmeysky', name: 'Красноармейский район', regionId: 'chelyabinsk', type: 'district' },

  // Пермский край - районы
  { id: 'perm-alexandrovsky', name: 'Александровский район', regionId: 'perm', type: 'district' },
  { id: 'perm-bардymsky', name: 'Бардымский район', regionId: 'perm', type: 'district' },
  { id: 'perm-bereznikovsky', name: 'Березниковский район', regionId: 'perm', type: 'district' },
  { id: 'perm-bolshesosnovsky', name: 'Большесосновский район', regionId: 'perm', type: 'district' },
  { id: 'perm-vereshchaginsky', name: 'Верещагинский район', regionId: 'perm', type: 'district' },
  { id: 'perm-gornozavodsky', name: 'Горнозаводский район', regionId: 'perm', type: 'district' },
  { id: 'perm-dobryanski', name: 'Добрянский район', regionId: 'perm', type: 'district' },
  { id: 'perm-ilinsky', name: 'Ильинский район', regionId: 'perm', type: 'district' },
  { id: 'perm-karагайsky', name: 'Карагайский район', regionId: 'perm', type: 'district' },
  { id: 'perm-kiselevsky', name: 'Киселёвский район', regionId: 'perm', type: 'district' },
  { id: 'perm-kosinsky', name: 'Косинский район', regionId: 'perm', type: 'district' },
  { id: 'perm-krasnovisherskyi', name: 'Красновишерский район', regionId: 'perm', type: 'district' },

  // Омская область - районы
  { id: 'omsk-azovsky-r', name: 'Азовский немецкий национальный район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-bolsherechensky', name: 'Большереченский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-bolsheukovsky', name: 'Большеуковский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-gоrkovskyi', name: 'Горьковский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-znamensky', name: 'Знаменский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-isikульsky', name: 'Исилькульский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-kaлачinsky', name: 'Калачинский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-kolosovsky', name: 'Колосовский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-kormilovsky', name: 'Кормиловский район', regionId: 'omsk', type: 'district' },
  { id: 'omsk-krutinsky', name: 'Крутинский район', regionId: 'omsk', type: 'district' },

  // Красноярский край - районы
  { id: 'krasnoyarsk-абанский', name: 'Абанский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-achinский', name: 'Ачинский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-балахтинский', name: 'Балахтинский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-березовский', name: 'Берёзовский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-bogotolsky', name: 'Боготольский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-boguchansky', name: 'Богучанский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-bolshemurtinsky', name: 'Большемуртинский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-bolsheuлuisky', name: 'Большеулуйский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-дзержинский', name: 'Дзержинский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-емельяновский', name: 'Емельяновский район', regionId: 'krasnoyarsk', type: 'district' },
  { id: 'krasnoyarsk-yeniseysky', name: 'Енисейский район', regionId: 'krasnoyarsk', type: 'district' },

  // Иркутская область - районы
  { id: 'irkutsk-alarsky', name: 'Аларский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-angarsky', name: 'Ангарский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-balaganski', name: 'Балаганский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-bayandaevsky', name: 'Баяндаевский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-bodaibinsky', name: 'Бодайбинский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-bokhansky', name: 'Боханский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-bratский', name: 'Братский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-zhigalovsky', name: 'Жигаловский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-zalarinsky', name: 'Заларинский район', regionId: 'irkutsk', type: 'district' },
  { id: 'irkutsk-ziminsky', name: 'Зиминский район', regionId: 'irkutsk', type: 'district' },

  // Тюменская область - районы
  { id: 'tyumen-aromashevsky', name: 'Аромашевский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-armensky', name: 'Абатский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-berdyuzhsky', name: 'Бердюжский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-vikulovsky', name: 'Викуловский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-голышмановский', name: 'Голышмановский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-ishimsky', name: 'Ишимский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-kazansky', name: 'Казанский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-nizhnetavdinsky', name: 'Нижнетавдинский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-omutinskyi', name: 'Омутинский район', regionId: 'tyumen', type: 'district' },
  { id: 'tyumen-sladkovsky', name: 'Сладковский район', regionId: 'tyumen', type: 'district' },

  // Алтайский край - районы
  { id: 'altai-krai-aleiskyi', name: 'Алейский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-altaisky', name: 'Алтайский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-biyskyi', name: 'Бийский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-blagoveshchensky', name: 'Благовещенский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-burlinsky', name: 'Бурлинский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-bystroistokskyi', name: 'Быстроистокский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-volchikhinskyi', name: 'Волчихинский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-yegoryevskyi', name: 'Егорьевский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-yesaulsky', name: 'Ельцовский район', regionId: 'altai-krai', type: 'district' },
  { id: 'altai-krai-zalesovsky', name: 'Залесовский район', regionId: 'altai-krai', type: 'district' },

  // Кемеровская область - районы
  { id: 'kemerovo-anzhero-sudzhenskyi', name: 'Анжеро-Судженский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-belovsky', name: 'Беловский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-guryevsky', name: 'Гурьевский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-izhmorskyi', name: 'Ижморский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-kemerovskyi', name: 'Кемеровский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-krapivinsky', name: 'Крапивинский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-leninsk-kuznetsкyi', name: 'Ленинск-Кузнецкий район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-mariinsky', name: 'Мариинский район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-novokuznetsкyi', name: 'Новокузнецкий район', regionId: 'kemerovo', type: 'district' },
  { id: 'kemerovo-prokopyevsky', name: 'Прокопьевский район', regionId: 'kemerovo', type: 'district' },

  // Томская область - районы
  { id: 'tomsk-alexandrovsky-t', name: 'Александровский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-asinovsky', name: 'Асиновский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-bakcharsky', name: 'Бакчарский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-verkhnekeтsky', name: 'Верхнекетский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-zyryansky', name: 'Зырянский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-kargasoksky', name: 'Каргасокский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-кozhevnikovsky', name: 'Кожевниковский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-кrivosheinsky', name: 'Кривошеинский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-molchanovsky', name: 'Молчановский район', regionId: 'tomsk', type: 'district' },
  { id: 'tomsk-parabelsky', name: 'Парабельский район', regionId: 'tomsk', type: 'district' },
];
