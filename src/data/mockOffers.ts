...
export const MOCK_OFFERS: Offer[] = [
  {
    id: '7',
    userId: 'doydum-invest-user',
    type: 'offer',
    title: 'Коммерческое предложение от ДОЙДУМ-ИНВЕСТ',
    description: 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "ДОЙДУМ-ИНВЕСТ" предлагает качественные строительные материалы и услуги. Работаем с юридическими и физическими лицами. Гибкие условия сотрудничества, индивидуальный подход к каждому клиенту.',
    ...
    fullAddress: 'г. Якутск, адрес компании ДОЙДУМ-ИНВЕСТ',
    availableDistricts: ['yakutsk-city', 'yakutsk-megino-kangalassky', 'yakutsk-khangalassky', 'yakutsk-namsky', 'yakutsk-churapchinsky'],
    images: [
      {
        id: 'img7',
    ...
    seller: {
      id: 'seller-doydum',
      name: 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "ДОЙДУМ-ИНВЕСТ"',
      type: 'legal-entity',
      ...
      statistics: {
        ...
        activeOffers: 1,
        completedOrders: 0,
        registrationDate: new Date('2025-12-02'),
      },
    },
