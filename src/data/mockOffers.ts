...
export const MOCK_OFFERS: Offer[] = [
  {
    ...
    type: 'offer',
    title: 'Мясо конины',
    description: 'Свежее натуральное мясо конины от ДОЙДУМ-ИНВЕСТ. Высокое качество, экологически чистый продукт. Подходит для приготовления различных блюд якутской и азиатской кухни. Поставка охлажденного мяса.',
    category: 'food',
    subcategory: 'meat',
    quantity: 500,
    unit: 'кг',
