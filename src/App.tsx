...
const AdminAIChat = lazyWithRetry(() => import("./pages/AdminAIChat"));
      ...
      <TooltipProvider>
        <TimezoneProvider>
          <DistrictProvider>
            ...
            <Route path="/admin/ai-chat" element={<AdminAIChat isAuthenticated={isAuthenticated} onLogout={handleLogout} />} />
