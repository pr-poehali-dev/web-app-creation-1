      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-3">
              <strong>1.3.</strong> Акцептом настоящей Оферты является регистрация пользователя на веб-сайте «Единая региональная товарно-торговая площадка», расположенном по адресу ертп.рф (далее – Сайт), и начало использования его функционала.
            </p>
