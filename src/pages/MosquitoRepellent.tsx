        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <button
            onClick={() => shareContent({
              ...
              imageUrl: 'https://cdn.poehali.dev/projects/1a60f89a-b726-4c33-8dad-d42db554ed3e/bucket/fecdcb8f-d804-4115-af1d-6de23bcc0d8a.jpg',
            })}
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2.5">
              ...
              <p className="text-xs text-green-800 leading-relaxed">
                <span className="font-semibold">Центральный регион — звук не слышен.</span> Ультразвуковой сигнал (17 500–19 000 Гц) практически не воспринимается слухом взрослого человека после 25 лет. Все остальные регионы (Якутия, Урал, Сибирь, Дальний Восток) используют слышимые частоты 40–320 Гц — это нормально и не вредно.
              </p>
            </div>
            <div className="flex items-start gap-2.5">
              <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center shrink-0 mt-0.5">
