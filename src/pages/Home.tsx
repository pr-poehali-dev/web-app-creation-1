...
<p><strong>Анализ потребностей местного рынка:</strong></p>
<ul>
...
<p><strong>Финансирование производства и поставки от конечных потребителей:</strong></p>
<ul>
          ...
          <div className="border border-amber-400 bg-amber-50 dark:bg-amber-950/30 rounded-lg p-4 md:p-5 mb-6">
            <div className="flex gap-3">
              ...
              <div className="text-[14px] md:text-[15px] text-amber-900 dark:text-amber-200 leading-relaxed space-y-2">
                ...
                <p>Для новых пользователей, присоединяющихся после завершения пилотного этапа, стартовый уровень составит 50% рейтинга надёжности (нейтральный уровень). Дальнейшее повышение рейтинга «Надёжности» возможно исключительно за счёт реальной активности пользователя по завершённым сделкам.</p>
                <p>Пользователи с более высоким рейтингом «Надёжности» получают приоритетное положение на площадке.</p>
              </div>
            </div>
          </div>
        </div>
