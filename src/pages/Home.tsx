            ...
            <div className="flex gap-3">
              ...
              <div className="text-[14px] md:text-[15px] text-amber-900 dark:text-amber-200 leading-relaxed space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 pl-1">
                  ...
                  <li>начисление 100&nbsp;% рейтинг надёжности сразу после регистрации.</li>
                </ul>
                <p>Для новых пользователей, присоединяющихся после завершения пилотного этапа, стартовый уровень составит 50&nbsp;% рейтинг надёжности (нейтральный уровень). Дальнейшее повышение рейтинга «Надёжности» возможно исключительно за счёт реальной активности и завершённой сделки.</p>
