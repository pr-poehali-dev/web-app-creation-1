      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-foreground">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Функциональность ЕРТП:</h2>
              <p className="mb-3">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Специализация ЕРТП:</h2>
              <p className="mb-3">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Почему ЕРТП важна:</h2>
              <ul className="space-y-3 pl-5">
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
                ...
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span><strong>Плановое производство и поставки:</strong> ЕРТП помогает адаптировать ваше производство к реальным потребностям местного рынка, сокращая излишки и убытки, получая заказы по заранее оговоренной цене, сроков поставки и объема.</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
            ...
            <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-6 rounded-lg border border-primary/20 mt-8">
              <p className="text-lg font-semibold">
                ЕРТП – это инструмент для развития местного бизнеса и экономики, обеспечивающий эффективное взаимодействие между производителями, поставщиками и потребителями для увеличения местного производства товарооборота и экономического суверенитета регионов.
              </p>
            </div>
          </div>
        </div>
