    ...
    <div className="flex gap-4 mb-6">
      ...
      <div className="w-[180px] relative">
        <div className="relative">
          <Input
            value={isTypeOpen ? typeSearch : (selectedType === 'all' ? 'Все типы' : selectedType === 'forward' ? 'Форвард предложения' : selectedType === 'forward-request' ? 'Форвард запрос' : 'Бартер')}
        ...
        {isTypeOpen && (
          <>
            ...
            <div className="absolute z-20 w-full mt-1 max-h-60 overflow-auto bg-background border border-input rounded-md shadow-lg">
              {[{value: 'all', label: 'Все типы'}, {value: 'forward', label: 'Форвард предложения'}, {value: 'forward-request', label: 'Форвард запрос'}, {value: 'barter', label: 'Бартер'}]
