...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    Удаляет:
    - Архивные предложения старше 12 месяцев
    - Завершенные/отмененные заказы старше 12 месяцев  
    - Архивные запросы старше 12 месяцев
    
    Защищает от переполнения БД при масштабировании до 10,000+ пользователей
    """
    ...
    try:
        ...
        # Дата отсечения - 12 месяцев назад
        ...
        return {
            ...
            'body': json.dumps({
                ...
                'stats': stats,
                'note': 'Run this monthly via cron or manually for database optimization'
            }),
            'isBase64Encoded': False
        }
