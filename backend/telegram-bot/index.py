    ...
    try:
        ...
        if text.startswith('/start'):
            ...
            response_text = (
                ...
                f"<b>Подключите уведомления одним кликом!</b>\n\n"
                f"Нажмите кнопку ниже — всё произойдёт автоматически:\n"
                f"✅ Telegram подключится к вашему профилю\n"
                f"✅ Вы будете получать уведомления об откликах\n\n"
                f"💡 Если вы ещё не зарегистрированы на сайте ЕРТТП, сначала войдите в аккаунт"
            )
            ...
            # Создаем inline кнопку с Web App для автоматического подключения
            keyboard = {
                'inline_keyboard': [[
                    {'text': '⚡ Подключить уведомления', 'web_app': {'url': f'{frontend_url}/telegram-connect'}}
                ]]
            }
